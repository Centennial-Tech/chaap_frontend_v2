...
export function PathwayRecommendation({ submissionId }: PathwayRecommendationProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setTimeout(() => {
      setRecommendation({
        ...
        confidence: 95,
        timeline: "3-6 months",
        explanation: "Based on your inputs, a 510(k) submission is recommended due to the device classification and technological characteristics.",
      });
      setIsLoading(false);
    }, 2000);
  };
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Answer a few questions to get your personalized FDA submission pathway
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  {["Class I", "Class II", "Class III"].map((classification) => (
                    <Button
                      key={classification}
                      type="button"
                      variant={formData.riskClassification === classification ? "default" : "outline"}
                      className={`text-sm ${
                        formData.riskClassification === classification 
                          ? "bg-purple-600 hover:bg-purple-700 text-white" 
                          : "hover:bg-gray-50"
                      }`}
                      onClick={() => handleInputChange("riskClassification", classification)}
                    >
                      {classification}
                    </Button>
                  ))}
              ...
              <Input
                ...
                onChange={(e) => handleInputChange("predicateDevice", e.target.value)}
            ...
            <div className="space-y-4">
              ...
              <Input
                ...
                onChange={(e) => handleInputChange("technologicalCharacteristics", e.target.value)}
