      ...
      <CardContent>
        {validQuestions.length > 0 ? (
          <>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <Badge className={safeGetPriorityColor(question.priority)}>
                      ...
                      <div className="flex items-center space-x-4 text-sm">
                        {question.linkedSection && (
                          <Button
                            variant="ghost"
                            size="sm"
                            className={`h-auto p-0 font-medium ${safeGetCategoryColor(question.category)}`}
                          >
            ...
            <Alert className="bg-blue-50 border-blue-200">
              ...
              <AlertDescription className="text-blue-800">
                <strong>Pro Tip:</strong> Prepare detailed, evidence-based responses to critical and high-priority questions first. 
                Consider how each answer strengthens your submission's regulatory position.
              </AlertDescription>
            </Alert>
          </>
        ) : (
          <div className="text-center py-8">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No Reviewer Questions Yet</h3>
            <p className="text-gray-600 mb-4">
              Reviewer questions will be generated based on your submission details and predicate analysis.
            </p>
