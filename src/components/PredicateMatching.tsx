      ...
      <CardContent>
        {predicateMatches && predicateMatches.length > 0 ? (
              ...
              {predicateMatches.map((match) => (
                <div
                  ...
                  className={`border rounded-lg p-4 transition-all duration-200 hover:shadow-md ${
                    match.isSelected ? "border-teal-300 bg-teal-50" : "border-gray-200"
                  }`}
                >
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-sm text-gray-500">{match.similarity}% similarity</span>
                  </div>
                  
                  <h4 className="font-medium text-gray-900 mb-2">{match.deviceName}</h4>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-500">Approved: {match.approvalDate}</span>
                    <Button
                      size="sm"
                      variant={match.isSelected ? "default" : "outline"}
                      onClick={() => handlePredicateSelect(match.id, !match.isSelected)}
                      className={
                        match.isSelected
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-blue-700">
                    The {predicateMatches.find(m => m.matchType === "primary")?.deviceName} shows the 
                    strongest technological similarity to your device. Consider reviewing their predicate 
                    comparison table and testing approach for insights into your submission strategy.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="text-center py-8">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No Predicate Matches Found</h3>
            <p className="text-gray-600 mb-4">
              No similar devices were found in the FDA database. This may indicate a novel device requiring De Novo classification.
            </p>
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <p className="text-yellow-700">
                <strong>AI Suggestion:</strong> Consider De Novo pathway due to device novelty. 
                This pathway is designed for novel devices that don't have suitable predicate devices.
              </p>
            </div>
          </div>
        )}
